...
### Example Redmine
    ...
    ActionDispatch::Callbacks.to_prepare do
      ...
      class RedmineSidekiq::Mailer::BeforeFilter::Mailer
        def issue_add(args)
    ...
    class RedmineSidekiq::Mailer::UseSidekiqMailer
...
RedmineSidekiq::Mailer adds to your ActionMailer classes the ability to send mails asynchronously.
